...
export const odinCase1 = Accessory('acc0', 'accessory', 'odin', 'case', 15, odinPhone1Image, 10)
export const odinCase2 = Accessory('acc1', 'accessory', 'odin','case', 15, odinPhone2Image, 10)
export const odinMug = Accessory('acc2', 'accessory', 'odin','mug', 11, odinMugImage, 10)
export const odinPillow = Accessory('acc3', 'accessory', 'odin', 'pillow', 10, odinPillowImage, 10)
export const odinStickers = Accessory('acc4', 'accessory', 'odin', 'sticker', 9, odinStickersImage, 10)
export const odinTote = Accessory('acc5', 'accessory', 'odin', 'tote', 8, odinToteImage, 10)
